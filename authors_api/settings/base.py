...
# Added another parent, since we are moving up three levels to get to the root dir
...
REST_AUTH = {
    ...
    "REGISTER_SERIALIZER": "core_apps.users.serialisers.CustomRegisterSerializer",
}
