...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('phone number'), max_length=30, default='+16024123456')
    ...
    city = models.CharField(verbose_name=_('city'), max_length=180, default='Tucson', blank=False, null=False)
    profile_photo = models.ImageField(verbose_name=_('profile photo'), default='#')
